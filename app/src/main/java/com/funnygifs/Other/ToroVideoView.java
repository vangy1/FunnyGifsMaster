...
@TargetApi(Build.VERSION_CODES.ICE_CREAM_SANDWICH_MR1) public class ToroVideoView
        extends TextureView implements MediaController.MediaPlayerControl {
    ...
    // TODO Apply this
    private im.ene.lab.toro.widget.ToroVideoView.OnPlaybackError mOnPlaybackErrorListener;
    ...
    public ToroVideoView(Context context, AttributeSet attrs, int defStyle) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, im.ene.lab.toro.R.styleable.ToroVideoView);
        try {
            mScaleMode = a.getInteger(im.ene.lab.toro.R.styleable.ToroVideoView_videoScaleMode, SCALE_MODE_DEFAULT);
        } finally {
            a.recycle();
        }
        initVideoView();
    ...
    @Override public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(im.ene.lab.toro.widget.ToroVideoView.class.getName());
    }

    @Override public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(im.ene.lab.toro.widget.ToroVideoView.class.getName());
    }
